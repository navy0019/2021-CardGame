...
Button.default={sprite=nil,width=0,height=0,color={1,1,1,1},normal={},press={},lock={},isLock=false,Check=Check,OnClick=OnClick,OnHold=OnHold,OnRelease=OnRelease,LockSwitch=LockSwitch}
Button.metatable={}
